      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="font-heading text-xl gold-text mb-3">{SITE_NAME}</h3>
          ...
          {/* Links */}
          <div>
            <h4 className="font-heading text-xs uppercase tracking-wider text-gold mb-3">Collection</h4>
          ...
          <div>
            <h4 className="font-heading text-xs uppercase tracking-wider text-gold mb-3">Maison</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-heading text-xs uppercase tracking-wider text-gold mb-3">Contact</h4>
        ...
        <div className="mt-8 pt-6 border-t border-dark-200 flex flex-col sm:flex-row justify-between items-center gap-4">

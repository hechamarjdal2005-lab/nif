...
export function ProductDetail({ product }: ProductDetailProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
      {/* Image Gallery */}
      <div>
        <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-dark-50 border border-dark-200 mb-4">
      ...
      <div>
        ...
        <h1 className="font-heading text-3xl sm:text-4xl text-white mb-3">{product.nom}</h1>
        ...
        <div className="flex items-baseline gap-3 mb-6">
          <span className="text-3xl font-semibold gold-text">{formatPrice(product.prix)}</span>
        </div>
